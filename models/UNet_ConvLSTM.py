...
def unet_convlstm_reg(input_shape: Tuple[int] = (16, 256, 256, 1),
    ...
    contex_b1 = layers.Cropping3D(cropping=((seq_len-1,0),(0,0),(0,0)), data_format="channels_last")(x_conv1_b1)
    ...
    contex_b2 = layers.Cropping3D(cropping=((seq_len-1,0),(0,0),(0,0)), data_format="channels_last")(x_conv1_b2)
    ...
    contex_b3 = layers.Cropping3D(cropping=((seq_len-1,0),(0,0),(0,0)), data_format="channels_last")(x_conv1_b3)
    ...
    contex_b4 = layers.Cropping3D(cropping=((seq_len-1,0),(0,0),(0,0)), data_format="channels_last")(x_conv1_b4)
    ...
    # Residual Decoder
    x_deconv_b5 = layers.Conv3DTranspose(filters=8*num_filters_base, kernel_size=(1, 2, 2), strides=(1,2,2), padding='same', activation="relu")(out_fl_b5)
    x_bn_b5 = layers.BatchNormalization()(x_deconv_b5)
    x_do_b5 = layers.Dropout(dropout_rate)(x_bn_b5)

    x_conv1_b6 = layers.Conv3D(filters=4*num_filters_base, kernel_size=(1,3,3), padding='same', activation="relu")(layers.concatenate([x_do_b5, out_fl_b4]))
    ...
    x_conv1_b7 = layers.Conv3D(filters=2*num_filters_base, kernel_size=(1,3,3), padding='same', activation="relu")(layers.concatenate([x_do_b6, out_fl_b3]))
    ...
    x_conv1_b8 = layers.Conv3D(filters=1*num_filters_base, kernel_size=(1,3,3), padding='same', activation="relu")(layers.concatenate([x_do_b7, out_fl_b2]))
    ...
    x_conv1_b9 = layers.Conv3D(filters=1*num_filters_base, kernel_size=(1,3,3), padding='same', activation="relu")(layers.concatenate([out_fl_b1, x_do_b8]))
